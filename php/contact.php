						...
						<div class="row">
							<div class="col-md-4 animate-box">
								...
								<ul class="contact-info">
									<li><span><i class="icon-map5"></i></span>303909, Костромская область, город Балашиха, бульвар Ломоносова, 41</li>
									<li><span><i class="icon-phone4"></i></span><a href="tel:+2463778713773">+2463778713773</a></li>
									<li><span><i class="icon-envelope2"></i></span><a href="#">info.contact@<span class="server-name"></span></a></li>
								</ul>
							</div>
							<div class="col-md-8 animate-box">
								<div class="row">
									<form action="thanks.php">
										...
										<div class="col-md-12">
											<div class="form-group">
												<textarea name="" class="form-control" id="" cols="30" rows="7" placeholder="Текст комментария"></textarea>
